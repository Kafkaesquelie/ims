                ...
                <tbody>
                    <?php foreach ($requests as $req): ?>
                        <tr>
                          ...
                          <td>
                            <?php echo remove_junk($req['req_department']); ?>
                          </td>
                            <td>
                            ...
                            <td class="text-center">
                                <a href="l_view.php?id=<?php echo (int)$req['id']; ?>" 
          ...
          <tbody>
            <?php foreach ($ics_transactions as $ics): ?>
              <tr>
                ...
                <td><?php echo remove_junk($ics['employee_name']); ?></td>
                ...
                <td>
                  <?php if ($ics['status'] == 'completed'): ?>
                    <span class="badge bg-success">Completed</span>
                  <?php elseif ($ics['status'] == 'returned'): ?>
                ...
                <td class="text-center">
                  <a href="ics_view.php?id=<?php echo (int)$ics['id']; ?>" 
                     class="btn btn-info btn-sm" title="View ICS">
                    <i class="fa fa-eye"></i> View
                  </a>
                </td>
              </tr>
          ...
          <tbody>
            <?php foreach ($par_transactions as $par): ?>
              <tr>
                ...
                <td><?php echo remove_junk($par['employee_name']); ?></td>
                ...
                <td>
                  <?php if ($par['status'] == 'completed'): ?>
                    <span class="badge bg-success">Completed</span>
                  <?php elseif ($par['status'] == 'returned'): ?>
                    <span class="badge bg-warning">Returned</span>
                  <?php else: ?>
                ...
                <td class="text-center">
                  <a href="par_view.php?id=<?php echo (int)$par['id']; ?>" 
                     class="btn btn-info btn-sm" title="View PAR">
                    <i class="fa fa-eye"></i> View
                  </a>
                </td>
              </tr>
...
<script>
    ...
    $('#datatable').DataTable({
        ...
        "columnDefs": [
            { "width": "14%", "targets": 0 },  // #
            { "width": "10%", "targets": 1 }, // Requested By       
            { "width": "15%", "targets": 2}, 
            { "width": "10%", "targets": 3 }, 
            { "width": "18%", "targets": 4 }, 
            { "width": "10%", "targets": 5 },  
