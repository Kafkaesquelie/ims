...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['first_name'])) {
    ...
    $query  = "INSERT INTO employees (user_id,first_name, last_name, middle_name, position, office, status, image, created_at, updated_at) 
               VALUES ('{$user_id}','{$first_name}', '{$last_name}', '{$middle_name}', '{$position}', '{$office}', '{$status}', '{$image_name}', NOW(), NOW())";
